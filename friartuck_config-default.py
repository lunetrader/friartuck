...
ROBINHOOD_USERNAME = "your_email@your_domain.com" # required
ROBINHOOD_PASSWORD = "your_robinhood_password"    # required
...
SESSION_EXPIRATION_SECONDS = 86400 # optional
...
SESSION_EXPIRATION_TOLERANCE = 14400 # optional
...
SESSION_FILE_NAME  = "session" # optional
SESSION_DIR_NAME   = ".friartuck" # optional
SESSION_BASE_DIR   = os.path.expanduser("~") # optional
